...
import org.dnynyog.common.EmailConstant;
import org.dnynyog.common.NotificationResponseCode;
...
import org.dnynyog.repository.NofificationRepo;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Autowired
    NofificationRepo repo;

    @Override
    public NotificationResponce sendNotification(NotificationRequest request) {
        NotificationResponce response = NotificationResponce.getInstance();
